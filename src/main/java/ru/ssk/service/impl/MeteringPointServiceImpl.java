...
public class MeteringPointServiceImpl implements MeteringPointService {
    ...
    @Override
    public List<MeteringPoint> findAllEntityPoints() {
        return meteringPointRepository.findAllEntityPoints();
    }

    @Override
    public List<MeteringPoint> findAllPersonPoints() {
        return meteringPointRepository.findAllPersonPoints();
    }
